...
import libraryImg from "../images/libraryimage2.jpg";
const OurJournals = () => {
  return (
    <div>
      <div className="bg-gray-100 px-6">
        <section className="header-section mt-16 py-6 grid grid-cols-1 md:grid-cols-2 container mx-auto px-2 md:px-6 relative items-center">
          ...
          <div className="text-left md:pr-10 mb-10 md:mb-0">
            ...
            <h2 className="text-4xl font-bold text-[#0B0C58] mb-4">
              Our Journals
            </h2>
            <p className="text-gray-600 mb-6 max-w-md">
              Explore a wide range of scholarly and industry-leading journals
              designed to inform, inspire, and advance knowledge. From research
              publications to expert insights, our journals cater to
